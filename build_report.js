...
const doc = new Document({
  ...
  sections: [{
    ...
    children: [
      ...
      new Paragraph({ alignment: AlignmentType.CENTER, children: [new TextRun({ text: 'Michael Smith (RVU22CSXXX)', italics: true, size: 22, font: 'Calibri' })] }),
      ...
      new Paragraph({ alignment: AlignmentType.CENTER, children: [new TextRun({ text: 'Dr./Prof. [Guide Name]', italics: true, size: 24, font: 'Calibri', color: C.h2 })] }),
      BR(), BR(),
      ...
      BR(), BR(), BR(),
      new Paragraph({ children: [new TextRun({ text: 'Dr./Prof. [Guide Name]', size: 22, font: 'Calibri' })] }),
      ...
      new Table({
        ...
        rows: [
          ...
          dataRow(['Q5', 'Avg AI score per user', 'Matthew Anderson highest at 95.0; lowest 76.0'], [1400, 4000, 3600], false),
          dataRow(['Q10', 'Users with no submissions', '3 users: Sarah, Olivia, Jessica'], [1400, 4000, 3600], true),
          dataRow(['Q14', 'Highest avg AI score (subquery)', 'Matthew Anderson: 95.0'], [1400, 4000, 3600], false),
      ...
      para('The original ER Design Document (Brio DBMS Design Document v1.0, March 2026, prepared by Michael Smith, Francis Reuben R, and David Miller) is enclosed as a separate PDF attachment.'),
    ],
  }],
});
